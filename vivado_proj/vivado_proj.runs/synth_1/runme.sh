...
HD_PWD='/home/it/Documents/rvsoc_v3/vivado_proj/vivado_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32i_soc_fpag_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rv32i_soc_fpag_top.tcl
