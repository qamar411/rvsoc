...
HD_PWD='/home/it/Documents/rvsoc_v3/vivado_proj/vivado_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32i_soc_fpag_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rv32i_soc_fpag_top.tcl -notrace
